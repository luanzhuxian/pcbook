...
type Storage struct {
	...
	Driver        Storage_Driver         `protobuf:"varint,1,opt,name=driver,proto3,enum=techschool_pcbook.Storage_Driver" json:"driver,omitempty"`
...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\x11techschool_pcbook\x1a\x14memory_message.proto\"\xa0\x01\n" +
	"\aStorage\x129\n" +
	"\x06driver\x18\x01 \x01(\x0e2!.techschool_pcbook.Storage.DriverR\x06driver\x121\n" +
	"\x06memory\x18\x02 \x01(\v2\x19.techschool_pcbook.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: techschool_pcbook.Storage.Driver
	(*Storage)(nil),     // 1: techschool_pcbook.Storage
	(*Memory)(nil),      // 2: techschool_pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: techschool_pcbook.Storage.driver:type_name -> techschool_pcbook.Storage.Driver
	2, // 1: techschool_pcbook.Storage.memory:type_name -> techschool_pcbook.Memory

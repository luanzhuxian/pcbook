...
type Screen struct {
	...
	Panel         Screen_Panel           `protobuf:"varint,3,opt,name=panel,proto3,enum=techschool_pcbook.Screen_Panel" json:"panel,omitempty"`
...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\x11techschool_pcbook\"\xa7\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x12D\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2$.techschool_pcbook.Screen.ResolutionR\n" +
	"resolution\x125\n" +
	"\x05panel\x18\x03 \x01(\x0e2\x1f.techschool_pcbook.Screen.PanelR\x05panel\x12\x1e\n" +
	"\n" +
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: techschool_pcbook.Screen.Panel
	(*Screen)(nil),            // 1: techschool_pcbook.Screen
	(*Screen_Resolution)(nil), // 2: techschool_pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: techschool_pcbook.Screen.resolution:type_name -> techschool_pcbook.Screen.Resolution
	0, // 1: techschool_pcbook.Screen.panel:type_name -> techschool_pcbook.Screen.Panel

...
const file_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x12auth_service.proto\x12\x11techschool_pcbook\x1a\x1cgoogle/api/annotations.proto\"F\n" +
	...
	"\vAuthService\x12e\n" +
	"\x05Login\x12\x1f.techschool_pcbook.LoginRequest\x1a .techschool_pcbook.LoginResponse\"\x19\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/auth/loginB)\n" +
...
var file_auth_service_proto_goTypes = []any{
	(*LoginRequest)(nil),  // 0: techschool_pcbook.LoginRequest
	(*LoginResponse)(nil), // 1: techschool_pcbook.LoginResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: techschool_pcbook.AuthService.Login:input_type -> techschool_pcbook.LoginRequest
	1, // 1: techschool_pcbook.AuthService.Login:output_type -> techschool_pcbook.LoginResponse

...
const file_filter_message_proto_rawDesc = "" +
	"\n" +
	"\x14filter_message.proto\x12\x11techschool_pcbook\x1a\x14memory_message.proto\"\xa4\x01\n" +
	"\x06Filter\x12\"\n" +
	"\rmax_price_usd\x18\x01 \x01(\x01R\vmaxPriceUsd\x12\"\n" +
	"\rmin_cpu_cores\x18\x02 \x01(\rR\vminCpuCores\x12\x1e\n" +
	"\vmin_cpu_ghz\x18\x03 \x01(\x01R\tminCpuGhz\x122\n" +
	"\amin_ram\x18\x04 \x01(\v2\x19.techschool_pcbook.MemoryR\x06minRamB)\n" +
...
var file_filter_message_proto_goTypes = []any{
	(*Filter)(nil), // 0: techschool_pcbook.Filter
	(*Memory)(nil), // 1: techschool_pcbook.Memory
}
var file_filter_message_proto_depIdxs = []int32{
	1, // 0: techschool_pcbook.Filter.min_ram:type_name -> techschool_pcbook.Memory

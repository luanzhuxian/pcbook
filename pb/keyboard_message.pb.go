...
type Keyboard struct {
	...
	Layout        Keyboard_Layout        `protobuf:"varint,1,opt,name=layout,proto3,enum=techschool_pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\x11techschool_pcbook\"\x9b\x01\n" +
	"\bKeyboard\x12:\n" +
	"\x06layout\x18\x01 \x01(\x0e2\".techschool_pcbook.Keyboard.LayoutR\x06layout\x12\x18\n" +
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: techschool_pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: techschool_pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: techschool_pcbook.Keyboard.layout:type_name -> techschool_pcbook.Keyboard.Layout

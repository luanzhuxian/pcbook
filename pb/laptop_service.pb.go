...
const file_laptop_service_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_service.proto\x12\x11techschool_pcbook\x1a\x14laptop_message.proto\"H\n" +
	...
	"\rLaptopService\x12a\n" +
	"\fCreateLaptop\x12&.techschool_pcbook.CreateLaptopRequest\x1a'.techschool_pcbook.CreateLaptopResponse\"\x00B)\n" +

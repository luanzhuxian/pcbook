...
type Memory struct {
	...
	Unit          Memory_Unit            `protobuf:"varint,2,opt,name=unit,proto3,enum=techschool_pcbook.Memory_Unit" json:"unit,omitempty"`
...
const file_memory_message_proto_rawDesc = "" +
	"\n" +
	"\x14memory_message.proto\x12\x11techschool_pcbook\"\xb2\x01\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x122\n" +
	"\x04unit\x18\x02 \x01(\x0e2\x1e.techschool_pcbook.Memory.UnitR\x04unit\"^\n" +
	"\x04Unit\x12\v\n" +
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: techschool_pcbook.Memory.Unit
	(*Memory)(nil),   // 1: techschool_pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: techschool_pcbook.Memory.unit:type_name -> techschool_pcbook.Memory.Unit
